  ...
  return (
    <section className="w-full bg-white py-24 flex items-center justify-center">
      <div className="w-full max-w-md px-4">
        ...
        <div
          className="relative w-full aspect-[9/11] rounded-[2.5rem] bg-white transition-all duration-500 overflow-hidden"
          style={{
        ...
        >
          ...
          <div
            className="absolute inset-4 rounded-[2rem] transition-all duration-700 overflow-hidden"
            style={{
          ...
          >
            ...
            >
              ...
              {[
                ...
                <div
                  key={idx}
                  className="absolute top-1/2 left-1/2 rounded-full transition-all duration-1000"
                  style={{
                    width: `${layer.size}px`,
              ...
              <div
                className="absolute top-1/2 left-1/2 w-11 h-11 rounded-full flex items-center justify-center transition-all duration-500 z-30"
                style={{
                  marginLeft: '-22px',
                  marginTop: '-22px',
                  ...
                  transform: isHovering ? 'translate3d(0, 0, 8px) scale(1.1)' : 'translate3d(0, 0, 4px)',
                  transformStyle: 'preserve-3d',
                }}
              >
                <div
            ...
            <div
              ...
              style={{
                background:
                  'radial-gradient(circle at 50% 60%, rgba(21, 182, 232, 0.12) 0%, transparent 65%)',
              }}
            />
            ...
            <div className="relative w-full h-full flex flex-col justify-between p-6 z-20">
              ...
              <div className="flex flex-col pt-4">
                ...
                >
                  Create stunning 3D experiences and use beautiful custom elements
                </p>
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center pt-16">
                <div
                  className="relative w-72 h-72 transition-all duration-700"
                  style={{
                    filter: 'drop-shadow(0 20px 40px rgba(21, 182, 232, 0.12)) drop-shadow(0 8px 20px rgba(22, 29, 30, 0.1))',
                    transform: isHovering ? 'scale(1.08) translateY(-8px)' : 'scale(1)',
                  }}
                >
                  <Image
                    src="/services/Kamera.png"
                    alt="3D Camera"
                    fill
                ...
                {/* Contact Shadow */}
                <div
                  className="absolute bottom-20 w-48 h-10 rounded-full transition-all duration-700"
                  style={{
                    background:
                      'radial-gradient(ellipse at center, rgba(21, 182, 232, 0.15) 0%, transparent 70%)',
                    filter: isHovering ? 'blur(20px)' : 'blur(14px)',
                  }}
                />
              </div>
              ...
              <div className="flex items-center justify-between z-30">
                ...
                <div className="flex items-center gap-3">
                  <span
                    className="text-[10px] font-bold tracking-[0.18em] uppercase transition-colors duration-300 cursor-pointer"
                    style={{ color: '#0a0a0a' }}
                    onMouseEnter={(e) => (e.currentTarget.style.color = '#15b6e8')}
                  ...
                  <div className="flex items-center gap-1.5">
                    {[
                      ...
                      <div
                        key={idx}
                        className="w-6 h-6 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-pointer"
                        style={{
