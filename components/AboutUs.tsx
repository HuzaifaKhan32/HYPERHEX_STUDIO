...
const PAKISTAN_CITIES = [
  { name: 'Peshawar',  top: '43%', left: '42.5%' }, // upper-left  — NW corner
  { name: 'Islamabad', top: '18%', left: '48%'   }, // upper-center — slightly right & below Peshawar
  { name: 'Lahore',    top: '23%', left: '47.5%' }, // upper-right  — far right
  { name: 'Karachi',   top: '58%', left: '39%'   }, // bottom-left  — wide south base
];
...
export default function AboutUsSection() {
  ...
  const globeY = useTransform(scrollYProgress, [0, 0.5], ['82%', '52%']);

  return (
    <section className="w-full bg-[#f4fafd] text-[#161d1e] antialiased">
      <div className="mx-auto flex max-w-[1280px] 2xl:max-w-[1600px] flex-col gap-8 px-5 py-16 lg:px-16 2xl:py-24">
        ...
        <div className="flex flex-col gap-3">
          ...
          <h1 className="flex flex-col text-4xl font-extrabold tracking-tight md:text-6xl lg:text-7xl 2xl:text-8xl">
            <span>Human-Centered AI,</span>
            <span className="bg-gradient-to-b from-[#3b494c] to-transparent bg-clip-text text-transparent opacity-50">
        ...
        <div className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-12">
          ...
          >
            ...
            <div className="relative z-10 flex w-full flex-col items-center p-8 pt-10 text-center md:p-12 2xl:pt-16">
              ...
              <h2 className="mt-5 text-2xl font-bold tracking-tight text-white md:text-3xl 2xl:text-4xl">
                Based in <span className="text-[#15b6e8]">Montréal, Canada</span>
              </h2>

              <div className="mt-6">
                <Button3D>Start a Project</Button3D>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 lg:col-span-5">
            ...
            >
              ...
              <div className="relative z-10 mt-6 flex flex-col gap-2">
                ...
                <div className="flex gap-1 text-xs">
                  ...
                  <span className="rounded-sm bg-[#161d1e] px-1 py-0.5 text-white">
                    ★½
                  </span>
                </div>
              </div>
            ...
            >
              <div className="relative min-h-[160px] 2xl:min-h-[200px] w-1/3 shrink-0 overflow-hidden rounded-2xl shadow-md">
                <Image
                  src="https://lh3.googleusercontent.com/aida/AEtjO1Ux30wtGXfH-TsNZXY11bzgEYSihumOXrgXNhDswWb0Sa8z5JyeEi_7Ib65tNQob9slWS6cjd_MOWINIzrwofwnHRA1JRzO1GwjL6WwfyQFwDakIkrqmNjZ2S0zS4oxoJe9mvfQVSPw8nq5Blpe_BFmavifyEvkqjSKOiapN2XnEh-Gd1iUCOjYChRHwUvIZdIJ8WQQ1bAeSmupFqP9zXVqQfO3I5zvipGXhe4WZNOCQeO9B83ffHHuwWJW"
                  alt="Portrait of Ava Collins"
                  fill
                  sizes="200px"
