...
const ALL_PROJECTS = [
  { id: 1,  title: 'Apex Vanguard V8',    tags: ['Automotive', 'Render'], category: 'Animation',    type: 'image' as const, image: '/portfolio/car-configurator.jpg' },
  { id: 2,  title: 'Hexa Core Identity',  tags: ['Abstract'],             category: 'Web',           type: 'image' as const, image: '/portfolio/commtel.jpg' },
  { id: 3,  title: 'Oculus Pavilion',     tags: ['Arch Viz'],             category: 'Architecture',  type: 'image' as const, image: '/portfolio/exterior-house.jpg' },
  { id: 4,  title: 'Volvo S90 Edition',   tags: ['Configurator'],         category: 'Configurator',  type: 'image' as const, image: '/portfolio/governor-house.jpg' },
  { id: 5,  title: 'Minimalist Dining',   tags: ['Interior'],             category: 'Architecture',  type: 'image' as const, image: '/portfolio/IVF.png' },
  { id: 6,  title: 'Future UI Kit',       tags: ['UI'],                   category: 'Web',           type: 'image' as const, image: '/portfolio/ns-arcade.jpg' },
  { id: 7,  title: 'Project Reel One',    tags: ['Motion', 'Video'],      category: 'Animation',     type: 'video' as const, videoId: 'oQnWA-22Bf4' },
  { id: 8,  title: 'Project Reel Two',    tags: ['Motion', 'Video'],      category: 'Animation',     type: 'video' as const, videoId: 'm2FYElEVclc' },
  { id: 9,  title: 'Project Reel Three',  tags: ['Motion', 'Video'],      category: 'Animation',     type: 'video' as const, videoId: 'WKOskq3aIQQ' },
  { id: 10, title: 'Project Reel Four',   tags: ['Motion', 'Video'],      category: 'Animation',     type: 'video' as const, videoId: '9JFPZnPXQ1Y' },
  { id: 11, title: 'Project Reel Five',   tags: ['Motion', 'Video'],      category: 'Animation',     type: 'video' as const, videoId: 'QhWmY9lXlZY' },
  { id: 12, title: 'Project Reel Six',    tags: ['Motion', 'Video'],      category: 'Animation',     type: 'video' as const, videoId: 'a0ESDiUHZFI' },
];
...
function VideoCard({ project }: { project: (typeof ALL_PROJECTS)[number] & { type: 'video' } }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-3xl cursor-pointer border-2 border-black/10 shadow-[0_4px_0_0_rgba(220,220,220,1)] hover:border-[var(--color-accent)] hover:shadow-[0_4px_0_0_rgba(21,182,232,1)] transition-all duration-300 transform hover:-translate-y-1 flex flex-col p-3"
    >
              ...
              {CATEGORIES.map((category) => {
                ...
                return (
                  <button
                    ...
                    style={isActive ? { backgroundColor: 'var(--color-accent)', boxShadow: 'inset 0 2px 4px rgba(0,0,0,0.15), 0 1px 0 rgba(255,255,255,0.15), 0 8px 20px -7px rgba(24,173,218,0.75)' } : {}}
                  >
                    {category}
                  </button>
                );
