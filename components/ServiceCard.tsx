...
export default function ServiceCard({
  ...
  return (
    <a
      ...
      className={`service-card group relative block h-full min-h-[300px] overflow-hidden rounded-xl border-2 border-outline-variant/30 bg-white text-black shadow-[0_4px_0_0_rgba(220,220,220,1)] hover:border-accent hover:shadow-[0_4px_0_0_rgba(21,182,232,1)] hover:-translate-y-0.5 active:translate-y-1 active:shadow-none transition-all duration-150 focus-visible:outline-none ${className}`}
    >
      {/* Default Unhovered State */}
      <div className="relative z-0 flex h-full min-h-[300px] flex-col justify-between items-center text-center p-8">
      ...
      >
        ...
        <div className="flex min-h-0 flex-col gap-3">
          ...
          <p
            className={`font-[family-name:var(--font-dm-sans)] text-sm leading-6 ${
