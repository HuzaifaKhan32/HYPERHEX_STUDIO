...
export default function ImageCarousel({ images }: ImageCarouselProps) {
  ...
  return (
    <>
      ...
      <div className="absolute left-1/2 z-20 hidden -translate-x-1/2 items-center gap-3 rounded-full border border-white/15 bg-black/45 px-4 py-2.5 shadow-[0_4px_24px_rgba(0,0,0,0.4)] backdrop-blur-md md:bottom-12 md:flex">
        {images.map((_, index) => (
          <motion.button
            key={index}
