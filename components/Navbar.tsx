  ...
  return (
    ...
    >
      ...
      >
        ...
        <nav className="hidden items-center gap-2 2xl:gap-3 rounded-full border border-outline-variant/30 bg-surface-container-low/80 p-1 2xl:p-1.5 shadow-[0_4px_10px_rgba(0,0,0,0.25)] backdrop-blur-2xl md:flex">
          {links.map((link) => {
