...
export const MAIN_CASE_STUDIES: CaseStudy[] = [
  ...
  createCaseStudy('oQnWA-22Bf4', 'Governor House – Conference Room', '3D Visualization', true, '/animation/governor-house.webp'),
  createCaseStudy('m2FYElEVclc', 'Nexgen Heights', '3D Architectural Animation', true, '/animation/nexgen.webp'),
...
export const SUB_CASE_STUDIES: CaseStudy[] = [
  ...
  createCaseStudy('SXNb1vR_snw', 'NS Arcade', 'Architectural Visualization', true, '/animation/ns-arcade.webp'),
  createCaseStudy('xHP3l2UPVwk', 'Commtel', '3D Design & Planning', true, '/animation/commtel.webp'),
  createCaseStudy('QhWmY9lXlZY', 'Modern Apartment Interior Design ', '3D Visualization', true, '/animation/interior-3d.webp'),
  createCaseStudy('NJgPMovdV2Y', 'Al Jannat Farmhouse', 'Cinematic Drone Video'),
  createCaseStudy('9JFPZnPXQ1Y', 'Call Center Interior 3D', '3D Planning', true, '/animation/call-center.webp'),
