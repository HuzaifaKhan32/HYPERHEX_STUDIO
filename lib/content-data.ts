...
export const PROJECTS: Project[] = [
  ...
  createYtProject('QhWmY9lXlZY', 'modern-apartment-interior', 'Modern Apartment Interior Design', ['Animations'], '/portfolio/interior-3d.webp', 'Modern Apartment', undefined, ['architectural-visualization'], 'Photorealistic interior design walkthrough for a modern luxury penthouse.'),
  createYtProject('oQnWA-22Bf4', 'governor-house-conference-room', 'Governor House – Conference Room', ['Animations'], '/portfolio/governor-house.webp', 'Governor House', undefined, ['architectural-visualization'], 'State conference hall 3D interior design walkthrough and lighting setup.'),
  createYtProject('9JFPZnPXQ1Y', 'call-center-interior-3d', 'Call Center Interior 3D', ['Animations'], '/portfolio/call-center.webp', 'Call Center', undefined, ['architectural-visualization'], 'Commercial corporate interior layout and workstation spatial rendering.'),
  ...
  createImgProject('img-governor', 'governor-house-render', 'Governor House Stills', '/portfolio/governor-house.webp', ['Visualization', 'Interior Designs'], 'Governor House', undefined, false, undefined, ['architectural-visualization'], 'Official architectural interior stills for Governor House conference room.'),
