...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    counter: '06 / 09',
    title: '3D Animation',
    description: 'Cinematic 3D commercial animations, mechanical motion graphics, and high-impact visual effects.',
    longDescription: 'Breathe motion into static concepts with broadcast-quality 3D animations, cinematic camera choreography, particle simulations, and hyper-detailed motion design.',
    imageSrc: '/services/drone.webp',
    capabilities: [
      'Cinematic Commercial Choreography',
      'Mechanical Exploded Explosions',
      'VFX & Particle Dynamics',
      'Architectural Fly-Through Films',
...
export const PROJECTS: Project[] = [
  ...
  createYtProject('etXi1RoYDnA', 'stadium-view-visualization', 'Stadium View Visualization', ['Animations', 'Visualization'], '/portfolio/stadium-view-visualization.webp', 'Stadium View Visualization', undefined, ['architectural-visualization', '3d-animation'], 'Large-scale arena spatial rendering and dynamic lighting fly-through.'),
  createYtProject('SXNb1vR_snw', 'ns-arcade-3d-animation', 'NS Arcade | 3D Animation', ['Animations', 'Visualization'], undefined, 'NS Arcade', undefined, ['architectural-visualization', '3d-animation'], '3D commercial plaza animation showcasing interior arcade and retail spaces.'),
  createYtProject('Jq_njk26M3E', 'commtel-3d-design', 'Commtel | 3D Design & Animation', ['Animations', 'Visualization'], undefined, 'Commtel', undefined, ['3d-product-visualization', '3d-animation'], 'Industrial telecom device breakdown and 3D product animation.'),
  createYtProject('7JT-j8gz5uU', 'luxury-watch-3d-animation', 'Luxury Watch 3D Animation', ['Animations', 'Visualization'], undefined, 'Luxury Watch', undefined, ['3d-product-visualization', '3d-animation'], 'Ray-traced luxury wristwatch animation with photorealistic macro detail.'),
  ...
  createYtProject('QhWmY9lXlZY', 'modern-apartment-interior', 'Modern Apartment Interior Design', ['Animations', 'Visualization', 'Interior Designs'], undefined, 'Modern Apartment', undefined, ['architectural-visualization'], 'Photorealistic interior design walkthrough for a modern luxury penthouse.'),
  createYtProject('oQnWA-22Bf4', 'governor-house-conference-room', 'Governor House – Conference Room', ['Animations', 'Visualization', 'Interior Designs'], undefined, 'Governor House', undefined, ['architectural-visualization'], 'State conference hall 3D interior design walkthrough and lighting setup.'),
  createYtProject('9JFPZnPXQ1Y', 'call-center-interior-3d', 'Call Center Interior 3D', ['Animations', 'Visualization'], undefined, 'Call Center', undefined, ['architectural-visualization'], 'Commercial corporate interior layout and workstation spatial rendering.'),
  createYtProject('WKOskq3aIQQ', 'mumtaz-residency', 'Mumtaz Residency', ['Animations', 'Visualization'], undefined, 'Mumtaz Residency', undefined, ['architectural-visualization', '3d-animation'], 'High-rise residential tower exterior render and elevation animation.'),
  createYtProject('m2FYElEVclc', 'nexgen-heights', 'Nexgen Heights', ['Animations', 'Visualization'], undefined, 'Nexgen Heights', undefined, ['architectural-visualization', '3d-animation'], 'Mixed-use skyscraper 3D architectural animation and nighttime lighting.'),
  ...
  createImgProject('img-commtel', 'commtel-project', 'Commtel Project Stills', '/portfolio/commtel.jpg', ['Visualization'], 'Commtel', undefined, false, undefined, ['3d-product-visualization'], 'High-detail product stills for Commtel hardware devices.'),
  createImgProject('img-exterior', 'exterior-house', 'Exterior House Render', '/portfolio/exterior-house.jpg', ['Visualization'], 'Exterior House', undefined, false, undefined, ['architectural-visualization'], 'Residential villa exterior visualization with natural daylighting.'),
  createImgProject('img-governor', 'governor-house-render', 'Governor House Stills', '/portfolio/governor-house.jpg', ['Visualization', 'Interior Designs'], 'Governor House', undefined, false, undefined, ['architectural-visualization'], 'Official architectural interior stills for Governor House conference room.'),
  createImgProject('img-arcade', 'ns-arcade-stills', 'NS Arcade Stills', '/portfolio/ns-arcade.jpg', ['Visualization'], 'NS Arcade', undefined, false, undefined, ['architectural-visualization'], 'Commercial plaza exterior elevation rendering for NS Arcade.'),
  ...
  createImgProject('img-bedroom', 'luxury-bedroom-suite', 'Luxury Bedroom Suite', '/portfolio/bedroom.webp', ['Visualization', 'Interior Designs'], 'Luxury Bedroom', [
